...
public class OptionTypeRegistryModule implements CatalogRegistryModule<OptionType> {
	...
	private OptionTypeRegistryModule() {
		this.main = Lists.newArrayList(OptionTypes.NAME, OptionTypes.LOOKING, OptionTypes.INTERACT, OptionTypes.GLOWING, OptionTypes.BABY, OptionTypes.CHARGED, OptionTypes.ANGRY, OptionTypes.SIZE, OptionTypes.SITTING, OptionTypes.CAREER, OptionTypes.HORSESTYLE, OptionTypes.HORSECOLOR, OptionTypes.HORSEVARIANT, OptionTypes.ZOMBIETYPE, OptionTypes.SKELETONTYPE, OptionTypes.CATTYPE, OptionTypes.RABBITTYPE);
